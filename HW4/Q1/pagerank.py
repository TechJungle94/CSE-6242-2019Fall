...
"""
def author():                                                                                             
        return 'dzhang373' # replace sroutray3 with your Georgia Tech username.                                                                                             
                                                                                              
def gtid():                                                                                               
    return 903513977 # replace with your GT ID number      
...
#############################################
            ...
            for item in range(0,len(new_scores)):
                new_scores[item] += (1 - damping_factor) * node_weights[item]
